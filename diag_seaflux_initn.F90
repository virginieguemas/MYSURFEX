...
IF (DGS%LCOEF) THEN
  ...
  ALLOCATE(DGS%XCD_SEA (KLU))
  ALLOCATE(DGS%XCD_ICE (KLU))
  ALLOCATE(DGS%XCD_FORM(KLU))
  ALLOCATE(DGS%XCH     (KLU))
  ALLOCATE(DGS%XCH_SEA (KLU))
  ALLOCATE(DGS%XCH_ICE (KLU))
  ALLOCATE(DGS%XCH_FORM(KLU))
  ALLOCATE(DGS%XCE     (KLU))
  ALLOCATE(DGS%XCE_SEA (KLU))
...
ELSE
  ALLOCATE(DGS%XCD     (0))
  ALLOCATE(DGS%XCD_SEA (0))
  ALLOCATE(DGS%XCD_ICE (0))
  ALLOCATE(DGS%XCD_FORM(0))
  ALLOCATE(DGS%XCH     (0))
  ALLOCATE(DGS%XCH_SEA (0))
  ALLOCATE(DGS%XCH_ICE (0))
  ALLOCATE(DGS%XCH_FORM(0))
  ALLOCATE(DGS%XCE     (0))
  ALLOCATE(DGS%XCE_SEA (0))
  ALLOCATE(DGS%XZ0     (0))
...
ENDIF
!
!* Embedded seaice scheme variable
!
