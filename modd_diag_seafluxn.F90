...
!
  ...
  REAL, POINTER, DIMENSION(:)   :: XCD_SEA  ! open water drag coefficient for wind (W/s2)
  REAL, POINTER, DIMENSION(:)   :: XCD_ICE  ! seaice drag coefficient for wind (W/s2)
  REAL, POINTER, DIMENSION(:)   :: XCD_FORM ! form drag coefficient for wind (W/s2)
  REAL, POINTER, DIMENSION(:)   :: XCH      ! drag coefficient for heat        (W/s)
  REAL, POINTER, DIMENSION(:)   :: XCH_SEA  ! open water drag coefficient for heat  (W/s)
  REAL, POINTER, DIMENSION(:)   :: XCH_ICE  ! seaice drag coefficient for heat (W/s)
  REAL, POINTER, DIMENSION(:)   :: XCH_FORM ! form drag coefficient for heat (W/s)
  REAL, POINTER, DIMENSION(:)   :: XCE      ! drag coefficient for vapor       (W/s/K)
  REAL, POINTER, DIMENSION(:)   :: XCE_SEA  ! open water drag coefficient for vapor       (W/s/K)
  ...
  REAL, POINTER, DIMENSION(:)   :: XLEI     ! sublimation heat flux over entire sea (W/m2) 
  REAL, POINTER, DIMENSION(:)   :: XLE_ICE  ! sublimation latent heat flux (seaice) (W/m2) 
...
!
  ...
  REAL, POINTER, DIMENSION(:)   :: XLEIC    ! sublimation heat flux over entire sea (W/m2) 
...
IF (LHOOK) CALL DR_HOOK("MODD_DIAG_SEAFLUX_N:DIAG_SEAFLUX_INIT",0,ZHOOK_HANDLE)
  ...
  NULLIFY(YDIAG_SEAFLUX%XCD_SEA)
  NULLIFY(YDIAG_SEAFLUX%XCD_ICE)
  NULLIFY(YDIAG_SEAFLUX%XCD_FORM)
  NULLIFY(YDIAG_SEAFLUX%XCH)
  NULLIFY(YDIAG_SEAFLUX%XCH_SEA)
  NULLIFY(YDIAG_SEAFLUX%XCH_ICE)
  NULLIFY(YDIAG_SEAFLUX%XCH_FORM)
  NULLIFY(YDIAG_SEAFLUX%XCE)
  NULLIFY(YDIAG_SEAFLUX%XCE_SEA)
