...
!
 CALL DEFAULT_SEAFLUX(XTSTEP,XOUT_TSTEP,CSEA_ALB,CSEA_FLUX,CSEA_SFCO2,LPWG, &
                     LPRECIP,LPWEBB,NZ0,NGRVWAVES,CPSISTAB,CPSIUNSTAB,XGAMMA,&
                     LPROGSST,NTIME_COUPLING,XOCEAN_TSTEP,XICHCE,CINTERPOL_SST,&
                     CINTERPOL_SSS)
