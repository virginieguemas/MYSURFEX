...
#endif
USE MODD_XIOS, ONLY : YSWBAND_DIM_NAME
!
!
...
IF (DGS%LSURF_BUDGET) THEN
   ...
   YCOMMENT='X_Y_'//YRECFM//' (W/m2)'
   CALL WRITE_SURF(DGU, U, &
                    HPROGRAM,YRECFM,DGS%XLEI(:),IRESP,HCOMMENT=YCOMMENT) 
   !
   YRECFM='GFLUX_SEA'
   YCOMMENT='X_Y_'//YRECFM//' (W/m2)'
   !
   ...
   IF (DGS%LRAD_BUDGET) THEN
      ...
      !
      CALL WRITE_SURF(DGU, U,&
           HPROGRAM,YRECFM,DGS%XSWBD(:,:),IRESP,HCOMMENT=YCOMMENT, HNAM_DIM2=YSWBAND_DIM_NAME)
      !
      YRECFM='SWU_SEA_'
      YCOMMENT='X_Y_'//YRECFM//' (W/m2)'
      !
      CALL WRITE_SURF(DGU, U,&
           HPROGRAM,YRECFM,DGS%XSWBU(:,:),IRESP,HCOMMENT=YCOMMENT, HNAM_DIM2=YSWBAND_DIM_NAME)
      !
#else
